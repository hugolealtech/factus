        ...
        Store.data.expenses.forEach(exp => {
            ...
            if (isApplicable) {
                ...
                if(matchesFilter) {
                    ...
                    // =========================================================
                    // LÓGICA DE CORES E STATUS (REFINADA)
                    // =========================================================
...
const App = {
    ...
    openImportModal() {
        ...
        <div class="modal-overlay" id="importModal">
            <div class="modal-content">
                <div style="display:flex; justify-content:space-between; align-items:center; margin-bottom:20px">
                    <h2 style="margin:0"><i class="fa-solid fa-paste"></i> Vavilov Text</h2>
                    <button class="btn btn-ghost" onclick="document.getElementById('importModal').remove()">X</button>
                </div>
                ...
                <div style="margin: 20px 0;">
                    ...
                    <textarea id="importText" rows="6" style="width:100%; font-family:monospace; font-size:0.8rem" placeholder="Ex: 15/01 UBER DO BRASIL 15,90..."></textarea>
                    <button class="btn btn-primary" style="margin-top:10px; width:100%" onclick="app.processPastedText()">Processar Texto</button>
                </div>

                <div id="importPreview" style="max-height: 250px; overflow-y: auto; display: none;">
                    <h4>Prévia da Importação (<span id="importCount">0</span> itens)</h4>
                    <div id="importList"></div>
                </div>

                <div style="margin-top: 20px; text-align: right;">
                    <button class="btn btn-success" id="btnConfirmImport" style="display:none" onclick="app.confirmImport()">Confirmar Importação</button>
                </div>
            </div>
        </div>`;
        document.body.insertAdjacentHTML('beforeend', modalHTML);
